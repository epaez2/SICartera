...
<html>
	...
	<body>
		...
		<div id="edit-gestion" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:gestionInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${gestionInstance?.version}" />
